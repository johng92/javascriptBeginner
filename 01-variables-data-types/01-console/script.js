...
const styl = 'padding: 10px; background-colr: green; color: purple; font-weight:700';
console.log('%cHardcore Programmer', styl);

const style= 'padding: 8px; background-color: green;';
console.log('%cJanSaathi', style);

const styler = 'padding: 10px; background-color: orange; color: black; font-weight:600; font-size: 14px;';
