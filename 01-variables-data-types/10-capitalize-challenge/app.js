...
nuSting = mySting.charAt(0).toUpperCase() + mySting.substring(1,7) + mySting.charAt(7).toUpperCase() + mySting.substring(8,16);
console.log(nuSting);

//4th METHOD to Uppercase by Brad Sir
const miSting = 'graphicdesigner';
minuSting = miSting[0].toUpperCase() + miSting.substring(1,7)+ miSting[7].toUpperCase()+ miSting.substring(8,15);
